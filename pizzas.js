let pizzaJson = [
    ...
    {id:2, name:'Calabresa', img:'images/pizza2.png', price:18.10, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    ...
    {id:8, name:'Variada', img:'images/pizza7.png', price:92.36, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'} ,
    {id:9, name:'Imaginária', img:'images/pizza7.png', price:0.50, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];